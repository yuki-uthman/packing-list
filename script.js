...
const rackParts = {
    ...
    47: { code: "RD8", name: "BACK PLATE SMALL (END RACK)" },
    48: { code: "RD8", name: "BACK PLATE BIG (END RACK)" },
    49: { code: "RD8", name: "STAND (END RACK)" },
    50: { code: "RD8", name: "FATHI TOP (END RACK)" },
    51: { code: "RD8", name: "FATHI BOTTOM (END RACK)" },
    52: { code: "RD8", name: "SHELF TOP (END RACK)" },
    53: { code: "RD8", name: "CLIP" },
    54: { code: "RD8", name: "SHELF BOTTOM (END RACK)" },
    55: { code: "RD8", name: "BRACKET FRONT (END RACK)" },
    56: { code: "RD8", name: "BACK PLATE SMALL" },
    57: { code: "RD8", name: "BACK PLATE BIG" },
    58: { code: "RD8", name: "STAND SINGLE SIDE" },
    59: { code: "RD8", name: "STAND DOUBLE SIDE" },
    60: { code: "RD8", name: "FATHI TOP" },
    61: { code: "RD8", name: "SHELF TOP" },
    62: { code: "RD8", name: "SHELF BOTTOM" },
    63: { code: "RD8", name: "BRACKET FRONT" },
};
...
const rack = {
    ...
    16: { code: "RD8", name: "SINGLE SIDE 6ft" },
    17: { code: "RD8", name: "DOUBLE SIDE 5ft" },
    18: { code: "RD8", name: "END RACK 5ft" },
